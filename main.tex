...
\begin{itemize}
    ...
    \item \SI{0.1}{\molar} \ce{FeCl3} turns from pale yellow to brown during the course of the reaction, accompanied by a vigorous effervescence after approximately 30 seconds.
