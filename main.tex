...
At the exception of the \SI{2.00}{\mL} (or \SI{0.356}{\molar}) \ce{H2O2} trials, both curves pass through all the data points within the margins of error. Hence, the experimental data support both the power law formulation and the Michaelis-Menten model. 
